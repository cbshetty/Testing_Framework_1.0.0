...
public class API_BaseClass {
	...
	public static Object ConstantClassObject;
	public static Boolean silent;
	public static RequestSpecification apiRequest;
	public static String apiRequestEndPoint;
	public static Response apiResponse;
	public static JSONObject apiRequestBody;
	public static String apiRequestBodyString;
	public static String apiListenText;
	public static boolean apiRequestHasListenText;
	private static LinkedList<String> apiRequestStringList=null;
	public static Boolean apiRequestHasBody;
	public static Headers apiRequestHeaders;
	public static Boolean apiRequestHasHeaders;
	public static Method GET = Method.GET;
	public static Method POST = Method.POST;
	public static Method method;
	public static HashMap<String,String> queryParam;
	public static Boolean apiRquestHasQueryParam;
	public static HashMap<Integer,String> pathParams;
	public static Boolean apiRquestHasPathParam;
	public static Headers apiResponseHeaders;
	public static int apiStatusCode;
	public static JsonPath apiResponseJsonPath;
	public static List<String> apiResponseParameters;
	public static List<String> apiResponseHeaderNames;
	public static Object BaseURI;
	public static String APIType="REST";
	//	public static WebSocket ws;
	private static String wsResponse=null;
	private static String apiResponseStatus;
	private static String apiResponseString=null;
	private static Object apiResponseObject=null;
	private static LinkedList<Object> apiResponsePongList=null;
	private static LinkedList<String> apiResponseStringList=null;
	private static LinkedList<Object> apiResponseObjectList=null;
	private static String wsReqestURI;
	private static String wsRequestBody;


	private static WebSocketListenerImpl sparkListenerImpl;
	private static WebSocket_Client sparkTicker;
	...
	public static void API_Setup(String APIName,Object ContantClassInstance, Object PojoMapClassInstance, Boolean ...silentrun) {	
		//RestAssured.baseURI = baseURL;
		API_Name=APIName;
		ConstantClassObject=ContantClassInstance;
	...
	/*public static void API_Setup_ws(String APIName, Object ContantClassInstance, Boolean... silentrun) throws Exception {
		//RestAssured.baseURI = baseURL;
		API_Name = APIName;
		ConstantClassObject = ContantClassInstance;
	...
	public static void quote1StdSetUp(String APIName, Object ContantClassInstance, Boolean... silentrun) throws Exception {
		//RestAssured.baseURI = baseURL;
		API_Name = APIName;
		ConstantClassObject = ContantClassInstance;
		SparkListenerImpl sparkListenerImpl = new SparkListenerImpl();
	...
	public static void quote1NcdexSetUp(String APIName, Object ContantClassInstance, Boolean... silentrun) throws Exception {
		//RestAssured.baseURI = baseURL;
		API_Name = APIName;
		ConstantClassObject = ContantClassInstance;
		SparkListenerImpl sparkListenerImpl = new SparkListenerImpl();
	...
	public static void quote3StdSetUp(String APIName, Object ContantClassInstance, Boolean... silentrun) throws Exception {
		//RestAssured.baseURI = baseURL;
		API_Name = APIName;
		ConstantClassObject = ContantClassInstance;
		SparkListenerImpl sparkListenerImpl = new SparkListenerImpl();
	...
	public static void quote3NcdexSetUp(String APIName, Object ContantClassInstance, Boolean... silentrun) throws Exception {
		//RestAssured.baseURI = baseURL;
		API_Name = APIName;
		ConstantClassObject = ContantClassInstance;
		SparkListenerImpl sparkListenerImpl = new SparkListenerImpl();
	...
	public static void quote4StdSetUp(String APIName, Object ContantClassInstance, Boolean... silentrun) throws Exception {
		//RestAssured.baseURI = baseURL;
		API_Name = APIName;
		ConstantClassObject = ContantClassInstance;
		SparkListenerImpl sparkListenerImpl = new SparkListenerImpl();
	...
	public static void quote4NcdexSetUp(String APIName, Object ContantClassInstance, Boolean... silentrun) throws Exception {
		//RestAssured.baseURI = baseURL;
		API_Name = APIName;
		ConstantClassObject = ContantClassInstance;
		SparkListenerImpl sparkListenerImpl = new SparkListenerImpl();
	...
	public static void setAPIRequestBody(String ... varStr) {
	...
	public static void setAPIRequestBody(String jsonString) {	
		apiRequestBodyString = jsonString;
		apiRequestHasBody=true;
	}
	public static void setAPIRequestBody(Object requestObject) {	
		apiRequestBodyString = getJSONStringFromObject(requestObject);
		apiRequestHasBody=true;
	}

	public static void addFormData(String formKey, Object formObject) {
		apiRequest.multiPart(formKey, formObject);	
	}
	public static void addFormParam(String formKey, String formValue) {
		apiRequest.multiPart(formKey, formValue);	
	}

	public static void setWSAPIListenJsonText(String jsonString) {	
		apiListenText = jsonString;
		apiRequestHasListenText=true;
	}
	public static void setWSAPIListenJsonText(Object requestObject) {	
		apiListenText = getJSONStringFromObject(requestObject);
		apiRequestHasListenText=true;
	}
	public static void setWSAPIListenText(String text) {	
		apiListenText = text;
		apiRequestHasListenText=true;
	}

	/*public static void setAPIRequestHeaders(String ... varStr) {
	...
	public static void setAPIRequestHeaders(Headers headers) {
		apiRequestHeaders =headers;
		apiRequestHasHeaders=true;
	}
	public static void setAPIRequestHeader(String headerName, String headerValue) {
		List<Header> headerList = new ArrayList<Header>();
	...
	public static void addAPIRequestHeader(Header header) {
		List<Header> headerList = new ArrayList<Header>();
		headerList.add(header);
		try {
			for(Header header1:apiRequestHeaders) {
	...
	public static void addAPIRequestHeader(String headerName, String headerValue) {
		List<Header> headerList = new ArrayList<Header>();
		try {
			for(Header header1:apiRequestHeaders) {
	...
	public static void addAPIRequestHeaders(String ... varStr) {
		List<Header> headerList = new ArrayList<Header>();
		for(String str:varStr) {
			Header header = new Header(str.split(":")[0], str.split(":")[1]);
			headerList.add(header);
	...
	public static void addAPIRequestHeaders(Headers headers) {
		List<Header> headerList = new ArrayList<Header>();
	...
	private static void set_API_RequestBody_And_Headers() {
	...
	private static void Send_API_Request() {
	...
	public static Headers getReponseHeaders() {
		return apiResponseHeaders;
	}
	public static JsonPath getReponseJsonPath() {
		return apiResponseJsonPath;
	}	

	private static void print_API_Request_Details() {
		//Request URL
	...
	private static void print_API_Request_Response_Details() {	
		apiResponseString = getAPIResponse();
	...
	private static void print_ping_response_details(){
		apiResponseString = getAPIResponse();
		apiResponseStatus = getAPIResponseStatus();
		//apiStatusCode = getAPIResponseStatusCode();
	...
	private static void print_listen_response_details() {
		apiResponseString = getAPIResponse();
		apiResponseStatus = getAPIResponseStatus();
		//apiStatusCode = getAPIResponseStatusCode();
	...
	public static String getJSONStringFromBinary(Object binary) {
		return new Gson().toJson(Get_API_Methods(PojoMapClassObject,API_Name+"_BinarytoPojo",(byte[])binary)).toString();
	}
	public static void Send_API_Request(Method requestType,String path) {
		method = requestType;
		apiRequestEndPoint=path;
		Send_API_Request();
		//apiResponse = apiRequest.request(requestType, path);
	}
	public static void Send_API_GET_Request(String path) {
		method=Method.GET;
		apiRequestEndPoint=path;
		Send_API_Request();
		//apiResponse=apiRequest.request(Method.GET, path);
	}
	public static void Send_API_GET_Request(Headers headers,String path) {
		method=Method.GET;
		apiRequestEndPoint=path;
	...
	public static void Send_API_POST_Request_WithEmptyBody(String path) {
		apiRequestEndPoint=path;
		set_API_RequestBody_And_Headers();
	...
	public static void Send_API_POST_Request_WithEmptyBody(Headers headers,String path) {
		apiRequestEndPoint=path;
		addAPIRequestHeaders(headers);
		set_API_RequestBody_And_Headers();
		//apiResponse=RestAssured.post(RestAssured.baseURI+path);
	...
	public static void Send_API_POST_Request(String path) {
		method=Method.POST;
		apiRequestEndPoint=path;
		Send_API_Request();
		//apiResponse=apiRequest.request(Method.POST, path);	
	}
	public static void Send_API_POST_Request(JSONObject requestBody,String path) {
		method=Method.POST;
		apiRequestEndPoint=path;
	...
	public static void Send_API_POST_Request(Headers requestHeaders,JSONObject requestBody,String path) {
		method=Method.POST;
		apiRequestEndPoint=path;
	...
	public static void Send_API_POST_Request(Headers requestHeaders,String JsonRequestBody,String path) {
		method=Method.POST;
		apiRequestEndPoint=path;
		addAPIRequestHeaders(requestHeaders);
	...
	public static void Send_API_Request(String BaseURI,Method requestType,String path) {
		//API_Setup(BaseURI);
		method = requestType;
		apiRequestEndPoint=path;
		Send_API_Request();
	...
	public static void Send_API_GET_Request(String BaseURI,String path) {
		//API_Setup(BaseURI);
		method=Method.GET;
		apiRequestEndPoint=path;
		Send_API_Request();
	...
	public static void Connect_WS_API(String BaseURI,String path) {
		apiRequestEndPoint=path;
		Send_API_Request();
	}
	public static void Send_API_GET_Request(String BaseURI,Headers headers,String path) {
		//API_Setup(BaseURI);
		method=Method.GET;
		apiRequestEndPoint=path;
		addAPIRequestHeaders(headers);
	...
	public static void Connect_WS_API(String BaseURI,Headers headers,String path) {
		apiRequestEndPoint=path;
		addAPIRequestHeaders(headers);
		Send_API_Request();
	}
	public static void WS_Ping() {
		try {
	...
	public static void WS_Listen(String message) {
		try {
	...
	public static void Convert_WS_Object_To_String(Object object) {

	}
	public static void Disconnect_WS_API() {
		try {
			sparkListenerImpl.resetResponses();
	...
	public static void Validate_WS_Connection_Open() {
	...
	public static void Validate_WS_Connection_Closed() {
	...
	public static void Send_API_POST_Request_WithEmptyBody(String BaseURI,String path) {
		//API_Setup(BaseURI);
		apiRequestEndPoint=path;
		set_API_RequestBody_And_Headers();
		//apiResponse=RestAssured.post(RestAssured.baseURI+path);
	...
	public static void Send_API_POST_Request_WithEmptyBody(String BaseURI,Headers headers,String path) {
		//API_Setup(BaseURI);
		apiRequestEndPoint=path;
		addAPIRequestHeaders(headers);
		set_API_RequestBody_And_Headers();	
	...
	public static void Send_API_POST_Request(String BaseURI,String path) {
		//API_Setup(BaseURI);
		method=Method.POST;
		apiRequestEndPoint=path;
		Send_API_Request();
	...
	public static void Send_API_POST_Request(String BaseURI,JSONObject requestBody,String path) {
		//API_Setup(BaseURI);
		method=Method.POST;
		apiRequestEndPoint=path;
		setAPIRequestBody(requestBody.toJSONString());
	...
	public static void Send_API_POST_Request(String BaseURI,String requestBody,String path) {
		//API_Setup(BaseURI);
		method=Method.POST;
		apiRequestEndPoint=path;
	...
	public static void Send_API_POST_Request(String BaseURI,Headers requestHeaders,JSONObject requestBody,String path) {
		//API_Setup(BaseURI);
		method=Method.POST;
		apiRequestEndPoint=path;
		addAPIRequestHeaders(requestHeaders);
	...
	public static void Send_API_POST_Request(String BaseURI,Headers requestHeaders,String JsonRequestBody,String path) {
		//API_Setup(BaseURI);
		method=Method.POST;
		apiRequestEndPoint=path;
		addAPIRequestHeaders(requestHeaders);
	...
	public static String getAPIResponseStatus() {
		if(APIType.equalsIgnoreCase("WS")) {
	...
	public static int getAPIResponseStatusCode() {
		if(APIType.equalsIgnoreCase("WS")) {
	...
	public static Object getJsonParameter(String jsonPath) {
		Object objvalue="";
		try {
			String jsonString;
	...
	public static Object getJsonParameter(String jsonResponse,String jsonPath) {
		Object objvalue="";
		try {
	...
	public static Boolean validateJsonParameterValue(String name, String jsonPath, Object ...values ) {
	...
	public static Boolean validateJsonParameterValue(String name, String jsonPath, List<Object> values  ) {
		Object actualValue = getJsonParameter(jsonPath);
		int count=0;
		List <Object> valueList= new ArrayList<Object>();
		for(Object o:values) {
	...
	public static void Validate_APIResponseStatus() {
	...
	public static void Validate_APIResponseStatus(int statusCode) {
	...
	public static void Validate_APIResponseStatus(String statusCode) {
	...
	public static void Validate_WebSocketResponseStatus(int statusCode) {
		if (apiStatusCode == statusCode) {
			//System.out.println("SUCCESS :: API_request completed successfully ");
	...
	public static Object getAPIResponseObject() {
		return apiResponseObject;
	}

	public static List<String> getAPIReponseStringList() {
		return apiResponseStringList;
	}
	public static List<Object> getAPIReponseObjectList() {
		return apiResponseObjectList;
	}
	public static List<Object> getAPIReponsePongList() {
		return apiResponsePongList;
	}
	public static List<Long> getAPIResponseTimeStamps(){
		return sparkTicker.GetMessageTimeStamps();
	}
	public static String getWSResponse() {
		return apiResponseString;
	}
	public static void Validate_APIResponse() {
	...
	public static void Validate_APIResponseBody(String parameterKey) {
	...
	public static void Validate_APIResponseBody_ParameterIsNotNull(String parameterKey) {
		//String responseJson = apiResponse.getBody().asString();
		String responseJson = apiResponseString;
		if(responseJson.contains("\""+parameterKey+"\":")) {
	...
	public static void Validate_APIResponseBody_ParameterIsNull(String parameterKey) {
		//String responseJson = apiResponse.getBody().asString();
		String responseJson = apiResponseString;
		if(responseJson.contains("\""+parameterKey+"\":")) {
			if(responseJson.contains("\""+parameterKey+"\":\"\"")||responseJson.contains("\""+parameterKey+"\":null")) {
	...
	public static Boolean Validate_APIResponseBody(String parameterKey, String paramterValue) {
		//String responseJson = apiResponse.getBody().asString();
		String responseJson = apiResponseString;
	...
	public static Boolean Validate_APIResponseBody(String parameterKey, int paramterValue) {
		//String responseJson = apiResponse.getBody().asString();
		String responseJson = apiResponseString;
		if(responseJson.contains("\""+parameterKey+"\":"+paramterValue)) {
			ReportFactory.PassTest("SUCCESS :: API response contains the expected parameter <font color=black>"+parameterKey+" : "+paramterValue+"</font>");
	...
	public static Boolean Validate_APIResponseBody(String parameterKey, Boolean paramterValue) {
		//String responseJson = apiResponse.getBody().asString();
		String responseJson = apiResponseString;
		if(responseJson.contains("\""+parameterKey+"\":"+paramterValue)) {
			ReportFactory.PassTest("SUCCESS :: API response contains the expected parameter <font color=black>"+parameterKey+" : "+paramterValue+"</font>");
	...
	public static Boolean Validate_APIResponseBody(String parameterKey, double paramterValue) {
		//String responseJson = apiResponse.getBody().asString();
		String responseJson = apiResponseString;
		if(responseJson.contains("\""+parameterKey+"\":"+paramterValue)) {
			ReportFactory.PassTest("SUCCESS :: API response contains the expected parameter <font color=black>"+parameterKey+" : "+paramterValue+"</font>");
	...
	public static Boolean AssertParameterValue(String parameterKey, String paramterValue) {
		//String responseJson = apiResponse.getBody().asString();
		String responseJson = apiResponseString;
		if(responseJson.contains("\""+parameterKey+"\":\""+paramterValue+"\"")) {
			//ReportFactory.PassTest("SUCCESS :: API response contains the expected parameter <font color=black>"+parameterKey+" : "+paramterValue+"</font>");
	...
	public static Boolean AssertParameterValue(String parameterKey, int paramterValue) {
		//String responseJson = apiResponse.getBody().asString();
		String responseJson = apiResponseString;
		if(responseJson.contains("\""+parameterKey+"\":"+paramterValue)) {
			//ReportFactory.PassTest("SUCCESS :: API response contains the expected parameter <font color=black>"+parameterKey+" : "+paramterValue+"</font>");
	...
	public static Boolean AssertParameterValue(String parameterKey, long paramterValue) {
		//String responseJson = apiResponse.getBody().asString();
		String responseJson = apiResponseString;
		if(responseJson.contains("\""+parameterKey+"\":"+paramterValue)) {
			//ReportFactory.PassTest("SUCCESS :: API response contains the expected parameter <font color=black>"+parameterKey+" : "+paramterValue+"</font>");
	...
	public static Boolean AssertParameterValue(String parameterKey, Boolean paramterValue) {
		//String responseJson = apiResponse.getBody().asString();
		String responseJson = apiResponseString;
		if(responseJson.contains("\""+parameterKey+"\":"+paramterValue)) {
			//ReportFactory.PassTest("SUCCESS :: API response contains the expected parameter <font color=black>"+parameterKey+" : "+paramterValue+"</font>");
	...
	public static Boolean AssertParameterValue(String parameterKey, double paramterValue) {
		//String responseJson = apiResponse.getBody().asString();
		String responseJson = apiResponseString;
		if(responseJson.contains("\""+parameterKey+"\":"+paramterValue)) {
			//ReportFactory.PassTest("SUCCESS :: API response contains the expected parameter <font color=black>"+parameterKey+" : "+paramterValue+"</font>");
	...
	public static void Validate_APIResponseBody(List<String> parameters ) {
		int count=0;
		//String responseJson = apiResponse.getBody().asString();
		String responseJson = apiResponseString;
	...
	public static void Validate_APIResponseBodyContains(String SearchText) {
		//String responseJson = apiResponse.getBody().asString();
		String responseJson = apiResponseString;
	...
	public static void Validate_APIResponseParamters() {
		int count=0;
		//String responseJson = apiResponse.getBody().asString();
		String responseJson = apiResponseString;
	...
	public static void Validate_WS_APIResponseParameters() {
	...
	public static void Validate_WS_APIResponseParameterTypes() {
		int count=0;
		//String responseJson = getWSResponse();
	...
	public static void Validate_APIResponseHeaders() {
		for(String str:apiResponseHeaderNames) {
			Validate_APIResponseHeader(str);
		}
	}
	public static long getAPIResponseTime() {

		return apiResponse.time();
	}

	public static void Validate_APIResponseTime(long millis) {
	...
	public static void Validate_APIResponseHeader(String headerName) {
	...
	public static void Validate_APIResponseHeader(Header header) {
	...
	public static void Validate_APIResponseHeader(String headerName,String headerValue) {
		Headers responseHeaders = apiResponse.getHeaders();
	...
	public static void Validate_APIResponseHeaders(Headers headers) {
		int count=0;
		Headers responseHeaders = apiResponse.getHeaders();
		for(Header header:headers) {
	...
	private static List<Object> reqDetails;
	public static Object Set_API_Request_Details(String APIName) {	
	...
	/*public static void Send_API_Request(String APIName,String ... queryParamValues) {
	...
	public static void Send_API_Request(String ... queryParamValues) {
	...
	public static Object Get_API_Methods(String methodName, Object ... params) {
	...
	public static Object Get_API_Methods(Object ClassObject,String methodName, Object ... params) {
		//IPO_Contants obj = new IPO_Contants();
		//API_Constants obj = new API_Constants();
		//Object obj = API_Constants.GetObject();
		//Class<?> classObj = obj.getClass();
	...
	public static Object Get_API_Constants(String methodName) {
		//IPO_Contants obj = new IPO_Contants();
		//API_Constants obj = new API_Constants();
		//Object obj = API_Constants.GetObject();
		//Class<?> classObj = obj.getClass();
	...
	public static Object Get_API_Constants(Object ClassObject,String methodName) {
		//IPO_Contants obj = new IPO_Contants();
		//API_Constants obj = new API_Constants();
		//Object obj = API_Constants.GetObject();
		//Class<?> classObj = obj.getClass();
	...
	public static void validateJsonSchema(String SchemaFileName){	
	...
	public static Boolean validateJsonParamterType(String paramPath,String paramType) {
		Boolean match=true;
	...
	public static Boolean validateJsonParameterType(String paramName,String paramType) {
		Boolean match = true;
		String wsResponse = apiResponseString;
		try {
			switch (paramType.toLowerCase()) {
	...
	public static Boolean validateJsonParamterType(Object JsonObject,String paramPath,String paramType) {
		Boolean match=true;
		paramPath.replaceAll(".", "/");
		if(paramPath.charAt(0)!='/') {
			paramPath="/"+paramPath;
	...
	public static Boolean validateJsonParamterType(String JsonString,String paramPath,String paramType) {
		Boolean match=true;
		paramPath.replaceAll(".", "/");
		if(paramPath.charAt(0)!='/') {
			paramPath="/"+paramPath;
	...
	/*public static void quote1StdJsonValidation(){
		try {
			ObjectMapper mapper = new ObjectMapper();
	...
	public static void quote1NcdexJsonValidation(){
		try {
			ObjectMapper mapper = new ObjectMapper();
	...
	public static void quote2StdJsonValidation(){
		try {
			ObjectMapper mapper = new ObjectMapper();
			assertJson(mapper.writeValueAsString(quote1StdResponse)).at("/ichange").isNumber();
			assertJson(mapper.writeValueAsString(quote1StdResponse)).at("/ilastPrice").isNumber();
	...
	public static void quote3StdJsonValidation(){
		try {
			ObjectMapper mapper = new ObjectMapper();
	...
	public static void quote3NcdexJsonValidation(){
		try {
			ObjectMapper mapper = new ObjectMapper();
	...
	public static void quote4StdJsonValidation(){
		try {
			ObjectMapper mapper = new ObjectMapper();
	...
	public static void quote4NcdexJsonValidation(){
		try {
			ObjectMapper mapper = new ObjectMapper();
	...
	public static List<String> Convert_Pipe_String_To_List(String pipeString){
	...
	public static List<String> Convert_Pipe_String_Array_To_List(String pipeString){
	...
	public static String Convert_Object_To_Pipe_String(Object obj) {
		String pipeString="";
	...
	public static void  roughFunnction() {
